...
export default observer(function DeleteDashboard({id}:Props){

    const { modalStore, dashboardStore } = useStore();

return(
    <Formik
    initialValues={{ error: null }}
    onSubmit={(values, { setErrors }) => dashboardStore.deleteDashboard(id).catch(error =>
